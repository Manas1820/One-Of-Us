  ...
  Widget build(BuildContext context) {
    ...
    return IntroductionScreen(
      ...
      pages: [
        ...
        PageViewModel(
          title: "IMPOSTERS win if ... ",
          body:
              "Even one of them survives till the end (the number of PLAYERS are less than or equal to the number of imposters). ",
          // image: _buildImage('real_life'),
          decoration: pageDecoration,
        ),
        PageViewModel(
          ...
          body:
          "They complete all of their tasks or they kick out all the imposters. ",
          // image: _buildImage('real_life'),
          decoration: pageDecoration,
        ),
      ],
